...
def get_parser():
    ...
    parser.add_argument(
        "--model_attr_path",
        required=False,
        default="/localhome/xsa55/Xiaohao/multiopd/scripts/mask2d/output/data_statistics/obj_info.json",
            ...
            for it in range(min(len(cat_pred[cat]), M_val[0])):
                ...
                for i, gt_anno in enumerate(cat_gt[cat]):
                    ...
                    if iou > max_iou and iou > T_val[0] and gtm_cat[cat][i] == -1:
                        ...
                        key = gt_anno["motion"]["object_key"]
                        diagonal_length = diagonal_lengths[key]
        ...
        for cat in K_val:
            ...
            for j in range(len(dtm_cat[cat])):
                ...
                if gt_idx > -1:
                    ...
                    key = cat_gt[cat][gt_idx]["motion"]["object_key"]
                    diagonal_length = diagonal_lengths[key]
